...
**10 runs** · model `gpt-5.1` · prompt `v11` · git `2c56eec`  
collected 2026-08-10T22:46:09Z · 66,568 tokens · 65s model time
...
| --- | --- |
| PIPE-3 required-item recall | median 0% · min 0% · max 3% |
| PIPE-4-class criticals | median 25.0 · min 25 · max 26 |
...
| `homonym:person:sarah_o` | 20% | must hedge / DISAMBIGUATE |
